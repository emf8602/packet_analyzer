...
def parse_args():
    ...
    Explanation of the arguments taken from the PCAP-FILTER(7) MAN PAGES.
    ...
    parser.add_argument("-host", "--host", type=str, help="Filter packet by destination")
    parser.add_argument("-port", "--port", type=str, help="Filter packet by source port")
    parser.add_argument("--bool_filter", nargs="*", choices=["ip", "tcp", "udp", "icmp"], help="Boolean filters to apply on packets")
